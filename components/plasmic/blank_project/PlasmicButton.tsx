...
import sty from "./PlasmicButton.module.css"; // plasmic-import: zBaxERlLfP7T/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: RpN6WVUCatWV/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: KDDf8xW7sQdZ/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__dk9D5, {
          [sty.freeBoxcolor_neutral__dk9D58TSi]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__dk9D5LkFlx]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__dk9D5NrCKt]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__dk9D5VeXSx]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__dk9D57Ra06]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__dk9D5E4Cr]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__dk9D5BiTtv]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__dk9D5BiTtvFp1Fs]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__mglIo, {
            [sty.freeBoxcolor_neutral__mglIo8TSi]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__mglIo8TSiAlX81]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__mglIoFkeqh]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__mglIoNrCKt]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__mglIo7Ra06]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__mglIoE4Cr]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__mglIoBiTtv]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__kcwmt)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__dpPu8, {
            [sty.freeBoxiconEnd__dpPu8BwXa1]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__dpPu8NrCKt]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__dpPu87Ra06]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__dpPu8E4Cr]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__iRrql)}
                role={"img"}
              />
            ),
